...
2.1. *Yearly Trends in Rates of Employment, Unemployment, and Inactivity, by Sex and Migration Background.*

2.2. *Yearly Trends in Average Weekly Working Hours, by Sex and Migration Background.*

2.3. *Yearly Trends in Rates of Temporary Employment, by Sex and Migration Background.*

2.4. *Yearly Trends in Rates of Employment in Essential Occupations, by Sex and Migration Background.*
...
2.1. *Changes in Occupational Concentration (1-digit ISCO) during the Great Recession, by Sex and Migration Background.*

2.2. *Changes in Occupational Concentration (1-digit ISCO) during the COVID-19 Pandemic, by Sex and Migration Background.*

The **Online Appendix** is comprised by ten supplementary tables:

A2.1. *Changes in Rates of Employment, Unemployment, and Inactivity, by Sex and Migration Background.*

A2.2. *Yearly Trends in Rates of Employment, Unemployment, and Inactivity, by Sex and Migration Background.*

A2.3. *Changes in Weekly Working Hours and Rates of Temporary Employment, by Sex and Migration Background.*

A2.4. *Yearly Trends in Average Weekly Working Hours by Sex and Migration Background.*

A2.5. *Yearly Trends in Rates of Temporary and Permanent Employment, by Sex and Migration Background.*

A2.6. *Yearly Trends in Mutual Information Index of Occupational Segregation by Sex and Migration Background.*

A2.7a. *Yearly Trends in Occupational Concentration (1-digit ISCO) among Women, by Migration Background.*

A2.7b. *Yearly Trends in Occupational Concentration (1-digit ISCO) among Men, by Migration Background.*

A2.8. *Yearly Trends in Rates of Employment in Essential Occupations, by Sex and Migration Background.*

A2.9. *Changes in Rates of Employment in Essential Occupations, by Sex and Migration Background.*
...
```{r generate-table-a22}
# Table A2.2. Yearly Trends in Rates of Employment, Unemployment, and Inactivity, by Sex and Migration Background.
...
tablea22_gt <- tablea22 |>
  ...
  tab_header(
    ...
    subtitle = md("*by Sex and Migration Background*")
  ) |>
...
```{r print-table-a22, echo = FALSE, fig.align = "center", fig.pos = "H"}
...
```{r generate-figure-21a}
# Figure 2.1a. Yearly Trends in Rates of Employment, by Sex and Migration Background.
...
```{r}
#| label: print-figure-21a
#| echo: false
#| fig-align: "center"
#| fig-width: 12
#| fig-height: 10
#| fig-pos: "H"
#| fig-cap: "**Figure 2.1a.** *Yearly Trends in Rates of Employment, by Sex and Migration Background.*"
...
```{r generate-figure-21b}
# Figure 2.1b. Yearly Trends in Rates of Unemployment, by Sex and Migration Background.
...
```{r}
#| label: print-figure-21b
#| echo: false
#| fig-align: "center"
#| fig-width: 12
#| fig-height: 10
#| fig-pos: "H"
#| fig-cap: "**Figure 2.1b.** *Yearly Trends in Rates of Unemployment, by Sex and Migration Background.*"
...
```{r generate-figure-21c}
# Figure 2.1c. Yearly Trends in Rates of Inactivity, by Sex and Migration Background.
...
```{r}
#| label: print-figure-21c
#| echo: false
#| fig-align: "center"
#| fig-width: 12
#| fig-height: 10
#| fig-pos: "H"
#| fig-cap: "**Figure 2.1c.** *Yearly Trends in Rates of Inactivity, by Sex and Migration Background.*"
...
```{r generate-table-a21}
# Table A2.1. Changes in Rates of Employment, Unemployment, and Inactivity, by Sex and Migration Background.
...
tablea21_gt <- tablea22 |>
  ...
  # Assigning an appropriate title and subtitle to the `gt` table.
  tab_header(
    title = md("**Table A2.1. Changes in Rates of Employment, Unemployment, and Inactivity,**"),
    subtitle = md("*by Sex and Migration Background*")
  ) |>
  # Imposing the FiveThirtyEight (538) theme on the `gt` table.
  gt_theme_538() |>
  ...
  # Setting the source note to comply with editorial requirements. 
  tab_source_note(
    source_note = md("Note: Changes are calculated by subtracting the % in 2009/12/20/22 from the % in 2007/19.<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.838.684); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a21, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-table-a24}
# Table A2.4. Yearly Trends in Average Weekly Working Hours, by Sex and Migration Background.
...
tablea24_gt <- tablea24 |>
  ...
  # Setting the source note to comply with editorial requirements. 
  tab_source_note(
    source_note = md("Note: Only employed respondents.<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.296.594); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a24, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-figure-22}
# Figure 2.2. Yearly Trends in Average Weekly Working Hours, by Sex and Migration Background.
...
```{r}
#| label: print-figure-22
#| echo: false
#| fig-align: "center"
#| fig-width: 12
#| fig-height: 8
#| fig-pos: "H"
#| fig-cap: "**Figure 2.2.** *Yearly Trends in Average Weekly Working Hours, by Sex and Migration Background.*"
...
```{r generate-table-a25}
# Table A2.5. Yearly Trends in Rates of Temporary and Permanent Employment, by Sex and Migration Background.
...
```{r print-table-a25, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-figure-23}
# Figure 2.3. Yearly Trends in Rates of Temporary Employment, by Sex and Migration Background.
...
```{r}
#| label: print-figure-23
#| echo: false
#| fig-align: "center"
#| fig-width: 12
#| fig-height: 12
#| fig-pos: "H"
#| fig-cap: "**Figure 2.3.** *Yearly Trends in Rates of Temporary Employment, by Sex and Migration Background.*"
...
```{r generate-table-a23}
# Table A2.3. Changes in Weekly Working Hours and Rates of Temporary Employment, by Sex and Migration Background.
...
tablea23_gt <- tablea24 |>
  ...
  # Assigning an appropriate title and subtitle to the `gt` table.
  tab_header(
    title = md("**Table A2.3. Changes in Weekly Working Hours and Rates of Temporary Employment,**"),
    subtitle = md("*by Sex and Migration Background*")
  ) |>
  # Imposing the FiveThirtyEight (538) theme on the `gt` table.
  gt_theme_538() |>
  ...
  # Setting the source note to comply with editorial requirements.
  tab_source_note(
    source_note = md("Note: Only employed respondents.<br>Changes are calculated by subtracting the % in 2009/12/20/22 from the % in 2007/19.<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.296.594); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a23, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
knitr::include_graphics("Visuals/Tables/TableA23.png")
```

```{r cleanup-2-3, include = FALSE}
# Removing all unused objects to keep the environment clean.
...
```{r generate-table-a26}
# Table A2.6. Yearly Trends in Mutual Information Index of Occupational Segregation by Sex and Migration Background.
...
tablea26_gt <- tablea26 |>
  ...
  # Setting the source note to comply with editorial requirements.
  tab_source_note(
    source_note = md("Note: Occupations are classified using 2-digit ISCO-88 (2007-10) or ISCO-08 (2011-22).<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.838.684); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a26, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-table-a27a}
# Table A2.7a. Yearly Trends in Occupational Concentration (1-digit ISCO) among Women, by Migration Background.
...
tablea27a_gt <- tablea27 |>
  ...
  tab_header(
    ...
    subtitle = md("*among Women, by Migration Background*")
  ) |>
  # Setting column labels as strings, so that `gt` does not mess with their visualisation.
  cols_label(
    `2007` = "2007", `2008` = "2008", `2009` = "2009",
  ...
  # Setting the source note to comply with editorial requirements.
  tab_source_note(
    source_note = md("Note: Women only. Occupations are classified using 2-digit ISCO-88 (2007-10) or ISCO-08 (2011-22).<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.838.684); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a27a, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-table-a27b}
# Table A2.7b. Yearly Trends in Occupational Concentration (1-digit ISCO) among Men, by Migration Background.
...
tablea27b_gt <- tablea27 |>
  ...
  tab_header(
    ...
    subtitle = md("*among Men, by Migration Background*")
  ) |>
  # Setting column labels as strings, so that `gt` does not mess with their visualisation.
  cols_label(
    `2007` = "2007", `2008` = "2008", `2009` = "2009",
  ...
  # Setting the source note to comply with editorial requirements.
  tab_source_note(
    source_note = md("Note: Men only. Occupations are classified using 2-digit ISCO-88 (2007-10) or ISCO-08 (2011-22).<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.838.684); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a27b, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-table-21}
# Table 2.1. Changes in Occupational Concentration (1-digit ISCO) during the Great Recession, by Sex and Migration Background.
...
table21_gt <- table21 |> 
  ...
  tab_header(
    ...
    subtitle = md("*during the Great Recession, by Sex and Migration Background*")
  ) |>
  # Imposing the FiveThirtyEight (538) theme on the `gt` table.
  gt_theme_538() |>
...
```{r print-table-21, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-table-22}
# Table 2.2. Changes in Occupational Concentration (1-digit ISCO) during the COVID-19 pandemic, by Sex and Migration Background.
...
table22_gt <- table21 |>
  ...
  tab_header(
    ...
    subtitle = md("*during the COVID-19 pandemic, by Sex and Migration Background*")
  ) |>
  # Imposing the FiveThirtyEight (538) theme on the `gt` table.
  gt_theme_538() |>
  # Fixing the stubhead label to make it clear that each row represents a different occupational category.
...
```{r print-table-22, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
knitr::include_graphics("Visuals/Tables/Table22.png")
```

```{r cleanup-6, include = FALSE}
# Removing all unused objects to keep the environment clean.
...
```{r generate-table-a28}
# Table A2.8. Yearly Trends in Rates of Employment in Essential Occupations, by Sex and Migration Background.
...
```{r print-table-a28, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-table-a29}
# Table A2.9. Changes in Rates of Employment in Essential Occupations, by Sex and Migration Background.
...
tablea29_gt <- tablea28 |>
  ...
  # Setting the source note to comply with editorial requirements.
  tab_source_note(
    source_note = md("Note: Only employed respondents. Changes are calculated by subtracting the % in 2009/12/20/22 from the % in 2007/19.<br>Source: Own calculations, EU-SILC 2007-22 (N = 1.296.594); weighted sample.")
  ) |>
  # Styling the source notes cells to make them prettier.
  tab_style(
    style = cell_text(align = "center"),
...
```{r print-table-a29, echo = FALSE, fig.align = "center", fig.pos = "H"}
# Including the now saved `gt` table as a graphic in the rendered `.pdf` report.
...
```{r generate-figure-24}
# Figure 2.4. Yearly Trends in Rates of Employment in Essential Occupations, by Sex and Migration Background.
...
```{r}
#| label: print-figure-24
#| echo: false
#| fig-align: "center"
#| fig-width: 10
#| fig-height: 8
#| fig-pos: "H"
#| fig-cap: "**Figure 2.4.** *Yearly Trends in Rates of Employment in Essential Occupations, by Sex and Migration Background.*"

# Including the now saved `ggplot2` figure as a graphic in the rendered `.pdf` report.
figure24
```

```{r cleanup-7, include = FALSE}
# Removing all unused objects to keep the environment clean.
